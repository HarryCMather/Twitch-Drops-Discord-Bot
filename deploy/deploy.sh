...
#        Deploy
#        appsettings.json
# 2 - The appsettings.json contains all substituted variables, so will overwrite the extracted artifact's Settings.json file.
...
echo "Overwriting the appsettings file with local copy...";
cp -f ../appsettings.json ./appsettings.json;
